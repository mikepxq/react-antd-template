...
const list = [
  { id: 0, username: "superAdmin", role: "superAdmin" as Model.RoleKeys, token: "superAdmin" },
  { id: 0, username: "common", role: "common" as Model.RoleKeys, token: "common" },
];
...
export const getUserInfo = (req: any) => {
  ...
  const _roleInfo = getRoleInfo(_userInfo.role);
